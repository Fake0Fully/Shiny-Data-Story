...
tampString <- read_file('tamp_overview.txt')
npString <- read_file('np_overview.txt')
...
conditionalPanel(condition = "output.clickme == 'tamp'",
    ...
    tabsetPanel(
      tabPanel("Overview",
        br(),
        column(8,
          HTML(markdownToHTML(fragment.only=TRUE, text=tampString
))
),
    column(4,
        br(),
...
tabPanel("Overview",
  br(),
  column(8,
  HTML(markdownToHTML(fragment.only=TRUE, text=npString))),
  column(4,
    br(),
